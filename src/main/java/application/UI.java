...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc) {
        try {
            ...
            char column = s.charAt(0); //a1; a2; b1. Pegando a primeira posição
            //Recortando o string a partir da posição 1 e convertendo o resultado
            //para inteiro
            int row = Integer.parseInt(s.substring(1)); // pegando a segunda posição
